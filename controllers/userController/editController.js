...
const edit = async (req, res) => {
  const { userID, name, email, password, profilePicURL, githubURL, xURL, linkedinURL, jobLocation, companyName, position, floatedProjects, floatedJobs, offeredReferrals, notifications, verificationStatus, batch, branch } = req.body;
